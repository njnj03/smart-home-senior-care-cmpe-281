  ...
  return (<div className="max-w-6xl mx-auto p-4 space-y-4">
    ...
    <div className="card">
      ...
      {alerts.length === 0 ? (
        ...
        <table className="table mt-2"><thead><tr><th>House</th><th>Type</th><th>Severity</th><th>Status</th><th>Created</th><th>Actions</th></tr></thead>
          <tbody>{alerts.map(a=>{ const house=houses.find(h=>h.house_id===a.house_id); return (<tr key={a.alert_id} className="hover:bg-gray-50">
